...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #87CEEB"><b>Tutorial Aplikasi</b></h2>
	<div class="bs-acc">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">
						Bagaimana Cara Berbelanja di Cake Me Out ?
					</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Lakukan Checkout pada pesanan anda</li>
						</ol>
					</div>
				</div>
			</div>
