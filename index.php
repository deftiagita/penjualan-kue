...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/4.jpg" style="width: 100%;  height: 650px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #87CEEB; border-bottom: 2px solid #87CEEB;"> Cake Me Out adalah salah satu bisnis makanan kue modern di Indonesia. Didirikan pada tahun 2003. Produk kami sehat, bergizi, dan terjangkau oleh semua orang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #87CEEB; margin-top: 80px;"><b>Produk Kami</b></h2>
